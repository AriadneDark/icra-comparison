...
<section class="card"><h3>Candidate facts</h3><table><thead><tr><th>Blind claim</th><th>Verdict</th><th>Correct intervals (relations)</th></tr></thead><tbody id="facts"></tbody></table></section>
    ...
    def save(self, payload: dict[str, Any]) -> None:
        ...
        if payload.get("complete"):
            ...
            for identifier, value in payload["claim_labels"].items():
                ...
                if (
                    value.get("label") == "yes"
                    and fact_by_id[identifier]["kind"] == "relation"
                    and not value.get("intervals")
                ):
                    raise ValueError(f"Accepted relation {identifier} needs corrected intervals")
