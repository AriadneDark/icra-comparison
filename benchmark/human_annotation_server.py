...
<section class="card"><h3>Candidate facts</h3><p class="muted">For a role track, keep only intervals where the box follows the correct role object. Exclude frames with a wrong box.</p><table><thead><tr><th>Blind claim</th><th>Verdict</th><th>Correct intervals</th></tr></thead><tbody id="facts"></tbody></table></section>
